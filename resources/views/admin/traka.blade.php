<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{url('/redirect')}}"><img src="assets/images/logo.png" alt="logo" /></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('narudzba')}}">
              ...
              <span class="menu-title">Narudzbe</span>
            </a>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('view_kategorije')}}">
              <span class="menu-icon">
